...
for d in $dims; do
  ...
  LD_PRELOAD=/home/luser/Repos/spack/opt/spack/linux-almalinux9-ivybridge/gcc-11.4.1/darshan-runtime-3.4.4-ykayvipyjq7hnrzq7qeqs5ekpn6nga4t/lib/libdarshan.so /cmatrix_generator -i $input_path -o $output_path -cols $d -r $d --copy
